...
flowchart LR
    ...
    subgraph Cloud["Hosting platforms"]
        GH["GitHub"]
        GL["GitLab"]
        BB["Bitbucket"]
    end
...
:::tip
Next up, we'll create an actual repository and look inside the magical `.git` folder. Continue to [Chapter 2](/git-primer/setup/).
:::
